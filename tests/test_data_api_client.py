...
class TestServiceMethods(object):
    ...
    def test_get_service_with_pending_data(self, data_client, rmock):
        rmock.get('http://baseurl/services/123?with_pending_data=True', json={'services': 'result'}, status_code=200)
    ...
    def test_update_pending_service(self, data_client, rmock):
        ...
        assert result == {'services': 'result'}
        assert rmock.called
        assert rmock.last_request.json() == {'services': {'foo': 'bar'}, 'updated_by': 'testuser@example.com'}
...
class TestSupplierMethods(object):
    ...
    def test_update_framework_contact_information(self, data_client, rmock):
        ...
        result = data_client.update_framework_contact_information(123, 'g-thing', {'foo': 'bar'}, 'supplier')
    ...
    def test_set_supplier_fvra_result(self, data_client, rmock):
        ...
        result = data_client.set_supplier_fvra_result(
            ...
            'fvra_default',
            {'key': 'value'},
            {'CheckDate': '2025-03-20T04:00:00', 'DUNS': '123456789', 'FVRAStatus': 'Pass'},
            'user',
        )
        ...
        assert rmock.request_history[0].json() == {
            ...
            'fvraFrozenResult': {
                ...
                'fvraResults': {'CheckDate': '2025-03-20T04:00:00', 'DUNS': '123456789', 'FVRAStatus': 'Pass'},
            },
        }
    ...
    def test_update_supplier_fvra(self, data_client, rmock):
        ...
        assert result == {'fvra': {'question': 'answer'}}
        assert rmock.called
        assert rmock.request_history[0].json() == {'updated_by': 'user', 'fvra': {'question': 'answer'}}
    ...
    def test_find_supplier_framework_applications_by_route(self, data_client, rmock):
        ...
        result = data_client.find_supplier_framework_applications_by_route('g-cloud-7', 'cloud-sourcing')

        assert result == {'supplierFrameworks': [{'supplierId': 1}, {'supplierId': 2}]}
        assert rmock.called

    def test_find_supplier_framework_applications_by_route_with_attributes(self, data_client, rmock):
        rmock.get(
            'http://baseurl/frameworks/g-cloud-7/suppliers/applications?route=cloud-sourcing'
...
class TestDraftServiceMethods(object):
    ...
    def test_validate_draft_service_with_page_questions(self, data_client, rmock):
        ...
        result = data_client.validate_draft_service(2, {'field': 'value'}, ['question1', 'question2'])
    ...
    def test_validate_draft_service_with_ignored_fields(self, data_client, rmock):
        ...
        result = data_client.validate_draft_service(2, {'field': 'value'}, None, ['question2', 'question3'])
...
class TestAuditEventMethods(object):
    ...
    def test_find_audit_events_with_data_framework_slug(self, data_client, rmock):
        rmock.get(
            'http://baseurl/audit-events?data-framework-slug=g-thing', json={'audit-event': 'result'}, status_code=200
        )
...
class TestFrameworkMethods(object):
    ...
    def test_delete_framework_communication_category(self, data_client, rmock):
        rmock.delete(
            'http://baseurl/frameworks/g-cloud-11/communication-category', json={'message': 'done'}, status_code=200
        )

        result = data_client.delete_framework_communication_category('g-cloud-11', 'Compliance', user='me@my.mine')

        assert result == {'message': 'done'}
        assert rmock.called
        assert rmock.request_history[0].json() == {'communicationCategory': 'Compliance', 'updated_by': 'me@my.mine'}
...
class TestDataAPIClientIterMethods(object):
    ...
    def test_find_supplier_framework_applications_by_route_iter(self, data_client, rmock):
        self._test_find_iter(
            data_client,
            rmock,
...
class TestCommunicationsMethods(object):
    def test_find_communications(self, data_client, rmock):
        rmock.get('http://baseurl/communications', json={'communications': 'result'}, status_code=200)
    ...
    def test_find_communications_adds_page_parameter(self, data_client, rmock):
        rmock.get('http://baseurl/communications?page=2', json={'communications': 'result'}, status_code=200)
    ...
    def test_find_communications_adds_supplier_id_parameter(self, data_client, rmock):
        rmock.get('http://baseurl/communications?supplier_id=1', json={'communications': 'result'}, status_code=200)
    ...
    def test_find_communications_adds_resolved_parameter(self, data_client, rmock):
        rmock.get('http://baseurl/communications?resolved=true', json={'communications': 'result'}, status_code=200)
    ...
    def test_find_communications_adds_resolution_parameter(self, data_client, rmock):
        rmock.get(
            'http://baseurl/communications?resolution=archived', json={'communications': 'result'}, status_code=200
        )
    ...
    def test_find_communications_adds_supplier_id_and_resolved_parameter(self, data_client, rmock):
        rmock.get(
    ...
    def test_find_communications_adds_category_parameter(self, data_client, rmock):
        rmock.get(
            'http://baseurl/communications?category=Compliance', json={'communications': 'result'}, status_code=200
        )
    ...
    def test_find_communications_adds_subject_parameter(self, data_client, rmock):
        rmock.get(
            'http://baseurl/communications?subject=Default Subject', json={'communications': 'result'}, status_code=200
        )
    ...
    def test_find_communications_adds_supplier_name_parameter(self, data_client, rmock):
        rmock.get(
            'http://baseurl/communications?supplier_name=Supplier 1', json={'communications': 'result'}, status_code=200
        )
    ...
    def test_find_communications_adds_message_text_parameter(self, data_client, rmock):
        rmock.get(
            'http://baseurl/communications?message_text=This is', json={'communications': 'result'}, status_code=200
        )
    ...
    def test_resolve_communication(self, data_client, rmock):
        ...
        result = data_client.resolve_communication(123, 456, 'archived', 'test@example.com')
...
class TestLotQuestionsResponsesMethods(object):
    ...
    def test_find_lot_questions_responses_applicants_for_framework_route(self, data_client, rmock):
        rmock.get(
        ...
        result = data_client.find_lot_questions_responses_applicants_for_framework_route('g-cloud-6', 'g-lot')
    ...
    def test_find_lot_questions_responses_applicants_for_framework_route_adds_with_evaluations_parameter(
        ...
        result = data_client.find_lot_questions_responses_applicants_for_framework_route(
    ...
    def test_find_lot_questions_responses_applicants_for_framework_route_adds_page_parameter(self, data_client, rmock):
        rmock.get(
        ...
        result = data_client.find_lot_questions_responses_applicants_for_framework_route('g-cloud-6', 'g-lot', page=2)
    ...
    def test_get_lot_questions_response_by_framework_route_suppler(self, data_client, rmock):
        rmock.get(
        ...
        result = data_client.get_lot_questions_response_by_framework_route_suppler('g-cloud-6', 'g-things', 1234)

        assert result == {'lotQuestionsResponses': 'result'}
        assert rmock.called

    def test_get_lot_questions_response_by_framework_route_suppler_should_return_404(self, data_client, rmock):
        rmock.get(
            'http://baseurl/lot-questions-responses/frameworks/g-cloud-6/routes/g-things/suppliers/1234',
            status_code=404,
        )
        ...
        try:
            data_client.get_lot_questions_response_by_framework_route_suppler('g-cloud-6', 'g-things', 1234)
        except HTTPError:
            assert rmock.called
    ...
    def test_validate_lot_questions_response(self, data_client, rmock):
        ...
        assert result == {'lotQuestionsResponses': {'question': 'answer'}}
        assert rmock.called
        assert rmock.request_history[0].json() == {'lotQuestionsResponses': {'question': 'answer'}}
    ...
    def test_validate_lot_questions_response_with_page_questions(self, data_client, rmock):
        ...
        result = data_client.validate_lot_questions_response(1234, {'question': 'answer'}, ['question'])
    ...
    def test_find_lot_questions_response_section_evaluations_adds_page_parameter(self, data_client, rmock):
        rmock.get(
            'http://baseurl/lot-questions-response-section-evaluations?framework=g-cloud-6&route=g-things&page=2',
            json={'lotQuestionsResponseSectionEvaluations': 'result'},
            status_code=200,
        )
...
class TestEvaluatorFrameworkLotMethods(object):
    ...
    def test_update_evaluator_framework_lot_section_status(self, data_client, rmock):
        ...
        result = data_client.update_evaluator_framework_lot_section_status(1234, 'locked', 'user')
    ...
    def test_find_evaluator_framework_lot_section_evaluations(self, data_client, rmock):
        rmock.get(
            'http://baseurl/evaluations/evaluator-framework-lot-section-evaluations?framework=g-cloud-6&route=g-things',
            json={'evaluatorFrameworkLotSectionEvaluations': 'result'},
            status_code=200,
        )
...
class TestTechnicalAbilityCertificatesMethods(object):
    ...
    def test_get_technical_ability_certificate(self, data_client, rmock):
        rmock.get('http://baseurl/technical-ability-certificates/1234', json={'tac': 'data'}, status_code=200)
    ...
    def test_authenticate_technical_ability_certificate(self, data_client, rmock):
        rmock.post('http://baseurl/technical-ability-certificates/auth', json={'authorization': True}, status_code=200)
    ...
    def test_update_technical_ability_certificate_with_page_questions(self, data_client, rmock):
        ...
        result = data_client.update_technical_ability_certificate(1234, {'question': 'answer'}, 'user', ['question'])
    ...
    def test_approve_technical_ability_certificate(self, data_client, rmock):
        rmock.post(
            'http://baseurl/technical-ability-certificates/1234/approve', json={'message': 'done'}, status_code=200
        )
...
class TestLotPricingsMethods(object):
    ...
    def test_create_lot_pricing(self, data_client, rmock):
        rmock.post('http://baseurl/lot-pricings', json={'lotPricings': {'question': 'answer'}}, status_code=201)
    ...
    def test_get_lot_pricing(self, data_client, rmock):
        rmock.get('http://baseurl/lot-pricings/1234', json={'lotPricings': 'result'}, status_code=200)
    ...
    def test_update_lot_pricing_with_page_questions(self, data_client, rmock):
        ...
        result = data_client.update_lot_pricing(1234, {'question': 'answer'}, 'user', ['question'])
    ...
    def test_complete_lot_pricing(self, data_client, rmock):
        rmock.post('http://baseurl/lot-pricings/1234/complete', json={'message': 'done'}, status_code=200)
