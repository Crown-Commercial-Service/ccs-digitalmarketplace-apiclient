...
class TestDataApiClient(object):
    ...
    def test_updated_by_user_can_be_set_in_constructor(self, rmock):
        data_client = DataAPIClient(
            "http://baseurl", "auth-token", user="testuser@example.com", enabled=True
        )
        ...
        data_client.update_supplier_declaration(
            123, "g-cloud-7", {"question": "answer"}
        )
    ...
    def test_value_error_is_raised_if_no_user_in_constructor_or_method_call(
...
class TestServiceMethods(object):
    ...
    def test_get_service(self, data_client, rmock):
        rmock.get(
            "http://baseurl/services/123", json={"services": "result"}, status_code=200
        )
    ...
    def test_get_service_returns_none_on_404(self, data_client, rmock):
        rmock.get(
            "http://baseurl/services/123", json={"services": "result"}, status_code=404
        )
    ...
    def test_find_services(self, data_client, rmock):
        rmock.get(
            "http://baseurl/services", json={"services": "result"}, status_code=200
        )
    ...
    def test_update_service_by_admin(
        self, data_client, rmock, wait_for_index_call_arg, wait_for_index_req_arg
    ):
        rmock.post(
    ...
    def test_update_pending_service(self, data_client, rmock):
        ...
        result = data_client.update_pending_service(
            123, {"foo": "bar"}, "testuser@example.com"
        )
    ...
    def test_approve_pending_service(self, data_client, rmock):
        ...
        assert result == {"services": "result"}
        assert rmock.called
        assert rmock.last_request.json() == {"updated_by": "testuser@example.com"}
    ...
    def test_reject_pending_service(self, data_client, rmock):
        ...
        result = data_client.reject_pending_service(
            123, "reason_text", "testuser@example.com"
        )
...
class TestUserMethods(object):
    ...
    def test_find_users_by_supplier_id(self, data_client, rmock):
        rmock.get(
            "http://baseurl/users?supplier_id=1234", json=self.user(), status_code=200
        )
        user = data_client.find_users(1234)

        assert user == self.user()

    def test_find_users_not_possible_with_supplier_id_and_role(
        self, data_client, rmock
    ):
        with pytest.raises(ValueError):
    ...
    def test_find_users_by_active_false(self, data_client, rmock):
        rmock.get(
            "http://baseurl/users?active=false", json=self.user(), status_code=200
        )
    ...
    def test_make_user_a_supplier(self, data_client, rmock):
        rmock.post("http://baseurl/users/123", json={}, status_code=200)
        data_client.update_user(
            123, supplier_id=123, role="supplier", updater="test@example.com"
        )
        assert rmock.called
        assert rmock.last_request.json() == {
            "updated_by": "test@example.com",
    ...
    def test_can_remove_user_personal_data(self, data_client, rmock):
        rmock.post(
            "http://baseurl/users/123/remove-personal-data", json={}, status_code=200
        )
    ...
    def test_can_update_user_research_opted_ins(self, data_client, rmock):
        rmock.post("http://baseurl/users/123", json={}, status_code=200)
        data_client.update_user(
            123, user_research_opted_in=True, updater="test@example.com"
        )
        assert rmock.called
        assert rmock.last_request.json() == {
            "updated_by": "test@example.com",
...
class TestSupplierMethods(object):
    def test_find_suppliers_with_no_prefix(self, data_client, rmock):
        rmock.get(
            "http://baseurl/suppliers", json={"services": "result"}, status_code=200
        )
    ...
    def test_get_supplier_by_id(self, data_client, rmock):
        rmock.get(
            "http://baseurl/suppliers/123", json={"services": "result"}, status_code=200
        )
    ...
    def test_update_framework_contact_information(self, data_client, rmock):
        ...
        assert rmock.called
        assert rmock.request_history[0].json() == {
            "frameworkContactInformation": {"foo": "bar"},
            "updated_by": "supplier",
        }
    ...
    def test_approve_pending_supplier_framework_description(self, data_client, rmock):
        ...
        data_client.approve_pending_supplier_framework_description(
            123, "g-thing", "test@example.com"
        )
        assert rmock.called
        assert rmock.last_request.json() == {"updated_by": "test@example.com"}
    ...
    def test_reject_pending_supplier_framework_description(self, data_client, rmock):
        ...
        data_client.reject_pending_supplier_framework_description(
            123, "g-thing", "The reason", "test@example.com"
        )
        assert rmock.called
        assert rmock.last_request.json() == {
    ...
    def test_create_central_digital_platform_connection(self, data_client, rmock):
        ...
        result = data_client.create_central_digital_platform_connection(
            1234, {"supplierInformation": "value"}, "My trading name", "user"
        )
    ...
    def test_update_supplier_central_digital_platform_data_frameworks_to_update(
        self, data_client, rmock
    ):
        rmock.post(
            "http://baseurl/suppliers/1234/central-digital-platform/update",
    ...
    def test_update_supplier_framework_central_digital_platform_data(
        self, data_client, rmock
    ):
        rmock.post(
    ...
    def test_set_supplier_declaration(self, data_client, rmock):
        ...
        result = data_client.set_supplier_declaration(
            123, "g-cloud-7", {"question": "answer"}, "user"
        )
    ...
    def test_update_supplier_declaration(self, data_client, rmock):
        ...
        result = data_client.update_supplier_declaration(
            123, "g-cloud-7", {"question": "answer"}, "user"
        )
    ...
    def test_set_supplier_evaluation_scores(self, data_client, rmock):
        ...
        result = data_client.set_supplier_evaluation_scores(
            123, "g-cloud-7", "some_lot_a", {"a": 2}, "user"
        )
    ...
    def test_update_supplier_evaluation_scores(self, data_client, rmock):
        ...
        result = data_client.update_supplier_evaluation_scores(
            123, "g-cloud-7", "some_lot_a", {"a": 2}, "user"
        )
    ...
    def test_set_supplier_evaluation_details(self, data_client, rmock):
        ...
        result = data_client.set_supplier_evaluation_details(
            123, "g-cloud-7", "some_lot_a", {"a": 2}, "user"
        )
    ...
    def test_update_supplier_evaluation_details(self, data_client, rmock):
        ...
        result = data_client.update_supplier_evaluation_details(
            123, "g-cloud-7", "some_lot_a", {"a": 2}, "user"
        )
    ...
    def test_set_supplier_fvra_result(self, data_client, rmock):
        ...
        assert rmock.request_history[0].json() == {
            ...
            "fvraFrozenResult": {
                ...
                "fvraAdditionalDeclarationAnswers": {"key": "value"},
                "fvraResults": {
                    "CheckDate": "2025-03-20T04:00:00",
                    "DUNS": "123456789",
                    "FVRAStatus": "Pass",
    ...
    def test_update_supplier_fvra(self, data_client, rmock):
        ...
        result = data_client.update_supplier_fvra(
            123, "g-cloud-7", {"question": "answer"}, "user"
        )
    ...
    def test_get_supplier_frameworks_with_technical_ability_certificates(
        self, data_client, rmock
    ):
        rmock.get(
        ...
        result = data_client.get_supplier_frameworks(
            123, with_technical_ability_certificates=True
        )
        assert result == {"frameworkInterest": [{"declaration": {"status": "started"}}]}
        assert rmock.called

    def test_get_supplier_frameworks_with_lot_questions_responses(
        self, data_client, rmock
    ):
        rmock.get(
        ...
        result = data_client.get_supplier_frameworks(
            123, with_lot_questions_responses=True
        )
        assert result == {"frameworkInterest": [{"declaration": {"status": "started"}}]}
        assert rmock.called
    ...
    def test_get_supplier_framework_info_with_technical_ability_certificates(
        self, data_client, rmock
    ):
        rmock.get(
        ...
        result = data_client.get_supplier_framework_info(
            123, "g-cloud-7", with_technical_ability_certificates=True
        )
        assert result == {
            "frameworkInterest": {
                "supplierId": 123,
    ...
    def test_get_supplier_framework_info_with_lot_questions_responses(
        self, data_client, rmock
    ):
        rmock.get(
        ...
        result = data_client.get_supplier_framework_info(
            123, "g-cloud-7", with_lot_questions_responses=True
        )
        assert result == {
            "frameworkInterest": {
                "supplierId": 123,
    ...
    def test_get_supplier_framework_info_with_lot_pricings(self, data_client, rmock):
        ...
        result = data_client.get_supplier_framework_info(
            123, "g-cloud-7", with_lot_pricings=True
        )
        assert result == {
            "frameworkInterest": {
                "supplierId": 123,
    ...
    def test_get_supplier_framework_info_with_cdp(self, data_client, rmock):
        ...
        result = data_client.get_supplier_framework_info(
            123, "g-cloud-7", with_cdp_supplier_information=True
        )
        assert result == {
            "frameworkInterest": {
                "supplierId": 123,
    ...
    def test_get_supplier_framework_info_with_evaluation_scores(
        self, data_client, rmock
    ):
        rmock.get(
        ...
        result = data_client.get_supplier_framework_info(
            123, "g-cloud-7", with_evaluation_scores=True
        )
        assert result == {
            "frameworkInterest": {
                "supplierId": 123,
    ...
    def test_set_supplier_framework_allow_declaration_reuse(self, data_client, rmock):
        ...
        result = data_client.set_supplier_framework_allow_declaration_reuse(
            123, "g-cloud-7", True, "user"
        )
    ...
    def test_set_supplier_framework_prefill_declaration(self, data_client, rmock):
        ...
        result = data_client.set_supplier_framework_prefill_declaration(
            8765, "breeches", "pyjamas", "user"
        )
        assert result == {
            "frameworkInterest": {"prefillDeclarationFromFrameworkSlug": "pyjamas"}
        }
    ...
    def test_set_supplier_framework_application_company_details_confirmed(
        self, data_client, rmock
    ):
        rmock.post(
        ...
        result = (
            data_client.set_supplier_framework_application_company_details_confirmed(
    ...
    def test_register_framework_agreement_returned_with_uploader_user_id(
        self, data_client, rmock
    ):
        rmock.post(
    ...
    def test_register_framework_agreement_returned_without_uploader_user_id(
        self, data_client, rmock
    ):
        rmock.post(
            "http://baseurl/suppliers/123/frameworks/g-cloud-7",
    ...
    def test_unset_framework_agreement_returned(self, data_client, rmock):
        ...
        result = data_client.unset_framework_agreement_returned(
            123, "g-cloud-7", "user"
        )
    ...
    def test_register_framework_agreement_countersigned(self, data_client, rmock):
        ...
        result = data_client.register_framework_agreement_countersigned(
            123, "g-cloud-7", "user"
        )
    ...
    def test_agree_framework_variation(self, data_client, rmock):
        ...
        result = data_client.agree_framework_variation(
            321, "g-cloud-99", "banana-split", 314, "someuser"
        )
    ...
    def test_find_framework_suppliers_with_statuses(self, data_client, rmock):
        ...
        result = data_client.find_framework_suppliers(
            "g-cloud-7", statuses="signed,on-hold"
        )
    ...
    def test_find_framework_suppliers_no_declarations(self, data_client, rmock):
        ...
        result = data_client.find_framework_suppliers(
            "g-cloud-7", with_declarations=False
        )
    ...
    def test_find_framework_suppliers_with_tac(self, data_client, rmock):
        ...
        result = data_client.find_framework_suppliers(
            "g-cloud-7", with_technical_ability_certificates=True
        )
    ...
    def test_find_framework_suppliers_with_lot_responses(self, data_client, rmock):
        ...
        result = data_client.find_framework_suppliers(
            "g-cloud-7", with_lot_questions_responses=True
        )
    ...
    def test_find_framework_suppliers_with_lot_pricings(self, data_client, rmock):
        ...
        result = data_client.find_framework_suppliers(
            "g-cloud-7", with_lot_pricings=True
        )
    ...
    def test_find_framework_suppliers_with_cdp_supplier_information(
        self, data_client, rmock
    ):
        rmock.get(
        ...
        result = data_client.find_framework_suppliers(
            "g-cloud-7", with_cdp_supplier_information=True
        )
    ...
    def test_find_supplier_framework_applications_by_route(self, data_client, rmock):
        ...
        result = data_client.find_supplier_framework_applications_by_route(
            "g-cloud-7", "cloud-sourcing"
        )

        assert result == {"supplierFrameworks": [{"supplierId": 1}, {"supplierId": 2}]}
        assert rmock.called

    def test_find_supplier_framework_applications_by_route_with_supplier_name_prefix(
        self, data_client, rmock
    ):
        rmock.get(
        ...
        result = data_client.find_supplier_framework_applications_by_route(
            "g-cloud-12", "cloud-sourcing", supplier_name_prefix="A"
        )

        assert result == {"supplierFrameworks": []}
        assert rmock.called

    def test_find_supplier_framework_applications_by_route_with_attributes(
        self, data_client, rmock
    ):
        rmock.get(
            "http://baseurl/frameworks/g-cloud-7/suppliers/applications?route=cloud-sourcing"
    ...
    def test_verify_supplier_framework_application_with_lot(self, data_client, rmock):
        ...
        result = data_client.verify_supplier_framework_application(
            "g-things-88", 1234, "g-thing"
        )
    ...
    def test_migrate_framework_application(self, data_client, rmock):
        ...
        result = data_client.migrate_framework_application(
            "g-things-88", 1234, 4567, "user"
        )
...
class TestAgreementMethods(object):
    ...
    def test_approve_agreement_for_countersignature(self, data_client, rmock):
        ...
        result = data_client.approve_agreement_for_countersignature(
            101, "chris@example.com", "1234"
        )
    ...
    def test_unapprove_agreement_for_countersignature(self, data_client, rmock):
        ...
        result = data_client.unapprove_agreement_for_countersignature(
            7890, "tactical.shorts@example.com", "6543"
        )
...
class TestDraftServiceMethods(object):
    ...
    def test_find_draft_services_by_framework_with_optional_params(
        self, data_client, rmock
    ):
        rmock.get(
    ...
    def test_update_draft_service_with_page_questions_and_ignored_fields(
        self, data_client, rmock
    ):
        rmock.post(
            "http://baseurl/draft-services/2",
    ...
    def test_validate_draft_service_with_page_questions_and_ignored_fields(
        self, data_client, rmock
    ):
        rmock.post(
            "http://baseurl/draft-services/2/validate",
...
class TestAuditEventMethods(object):
    ...
    def test_find_audit_events_with_page_and_type(self, data_client, rmock):
        ...
        result = data_client.find_audit_events(
            page=123, audit_type=AuditTypes.contact_update
        )
    ...
    def test_find_audit_events_with_invalid_audit_type(self, data_client, rmock):
        with pytest.raises(TypeError):
            data_client.find_audit_events(
                page=123, audit_type="invalid", acknowledged="all", audit_date=None
            )
    ...
    def test_create_audit_with_no_data_defaults_to_empty_object(
        self, data_client, rmock
    ):
        rmock.post(
            "http://baseurl/audit-events",
...
class TestFrameworkMethods(object):
    def test_create_framework(self, data_client, rmock):
        ...
        assert rmock.last_request.json() == {
            "frameworks": {
                ...
                "fvraSettings": {"fvra": True},
                "evaluationSettings": {"evaluation": False},
                "technicalAbilityCertificateSettings": {"tac": True},
                "lotPricingSettings": {"lotPricing": False},
                "lots": [],
                "name": "Digital Things",
    ...
    def test_update_framework(self, data_client, rmock):
        ...
        result = data_client.update_framework(
            framework_slug="g-cloud-11", data={"key": "value"}, user="me@my.mine"
        )
    ...
    def test_transition_dos_framework(self, data_client, rmock):
        ...
        result = data_client.transition_dos_framework(
            framework_slug="dos-22",
            expiring_framework_slug="dos-21",
            user="Clem Fandango",
        )
    ...
    def test_update_framework_communication_category(self, data_client, rmock):
        ...
        assert rmock.called
        assert rmock.request_history[0].json() == {
            "communicationCategories": {"key": "value"},
            "updated_by": "me@my.mine",
        }
    ...
    def test_delete_framework_communication_category(self, data_client, rmock):
        ...
        result = data_client.delete_framework_communication_category(
            "g-cloud-11", "Compliance", user="me@my.mine"
        )
...
class TestBriefMethods(object):
    ...
    def test_update_brief_award_brief_response(self, data_client, rmock):
        ...
        result = data_client.update_brief_award_brief_response(
    ...
    def test_update_brief_award_details(self, data_client, rmock):
        ...
        result = data_client.update_brief_award_details(
            123,
            456,
            {"awardedContractStartDate": "2020-12-31", "contractValue": "99.95"},
            "user@email.com",
        )
    ...
    def test_unaward_brief_response(self, data_client, rmock):
        ...
        result = data_client.unaward_brief_response(
            123, 456, updated_by="user@email.com"
        )
    ...
    def test_get_brief(self, data_client, rmock):
        rmock.get(
            "http://baseurl/briefs/123", json={"briefs": "result"}, status_code=200
        )
    ...
    def test_find_briefs(self, data_client, rmock):
        rmock.get(
            "http://baseurl/briefs?user_id=123", json={"briefs": []}, status_code=200
        )
    ...
    def test_find_briefs_by_lot_status_framework_and_human_readable(
        self, data_client, rmock
    ):
        rmock.get(
    ...
    def test_find_briefs_closed_after_date(self, data_client, rmock):
        ...
        result = data_client.find_briefs(
            status_date_filters={"closed_after": "2017-10-20"}
        )
    ...
    def test_add_brief_clarification_question(self, data_client, rmock):
        ...
        result = data_client.add_brief_clarification_question(
            1, "Why?", "Because", "user@example.com"
        )
...
class TestFrameworkAgreementMethods(object):
    ...
    def test_create_framework_agreement(self, data_client, rmock):
        ...
        result = data_client.create_framework_agreement(
            10,
            "g-cloud-8",
            {"signerName": "Rex", "signerRole": "Driver of the Aegis"},
            "user@example.com",
        )
    ...
    def test_update_framework_agreement(self, data_client, rmock):
        ...
        result = data_client.update_framework_agreement(
            12345, {"new": "details"}, "user@example.com"
        )
    ...
    def test_update_framework_agreement_undo_countersign(self, data_client, rmock):
        rmock.post(
            "http://baseurl/agreements/12345/undo-countersign", json={}, status_code=200
        )

        result = data_client.update_framework_agreement_undo_countersign(
    ...
    def test_sign_framework_agreement_with_no_signed_agreement_details(
        self, data_client, rmock
    ):
        rmock.post(
    ...
    def test_sign_framework_agreement_with_signed_agreement_details(
        self, data_client, rmock
    ):
        rmock.post(
            "http://baseurl/agreements/12345/sign",
        ...
        result = data_client.sign_framework_agreement(
            12345, "user@example.com", {"uploaderUserId": 20}
        )
...
class TestDirectAwardMethods(object):
    ...
    def test_find_direct_award_projects(
        ...
        rmock.get(
            "/direct-award/projects{}".format(expected_query_string),
            json={"project": "ok"},
            status_code=200,
        )
    ...
    def test_find_direct_award_project_searches(
        self, data_client, rmock, user_id, page, active, expected_query_string
    ):
        rmock.get(
    ...
    def test_get_direct_award_project_search(self, data_client, rmock):
        rmock.get(
            "/direct-award/projects/1/searches/2?user-id=123",
            json={"search": "ok"},
            status_code=200,
        )

        result = data_client.get_direct_award_project_search(
            user_id=123, project_id=1, search_id=2
        )
        assert result == {"search": "ok"}

    def test_lock_direct_award_project(self, data_client, rmock):
        rmock.post(
            "/direct-award/projects/1/lock", json={"project": "ok"}, status_code=200
        )

        result = data_client.lock_direct_award_project(
            user_email="user@email.com", project_id=1
        )
    ...
    def test_record_direct_award_project_download(self, data_client, rmock):
        rmock.post(
            "/direct-award/projects/1/record-download",
            json={"project": "ok"},
            status_code=200,
        )

        result = data_client.record_direct_award_project_download(
            user_email="user@email.com", project_id=1
        )
    ...
    def test_create_direct_award_project_outcome_none_suitable(
        self, data_client, rmock
    ):
        rmock.post(
...
class TestDataAPIClientIterMethods(object):
    def _test_find_iter(
        self, data_client, rmock, method_name, model_name, url_path, iter_kwargs={}
    ):
        rmock.get(
    ...
    def test_find_framework_suppliers_iter(self, data_client, rmock):
        rmock.get(
            ...
            json={
                "links": {
                    "next": "http://baseurl/frameworks/g-cloud-8/suppliers?page=2"
                },
    ...
    def test_find_draft_services_iter(self, data_client, rmock):
        rmock.get(
            ...
            json={
                "links": {
                    "next": "http://baseurl/draft-services?supplier_id=123&page=2"
                },
                "services": [{"id": 1}, {"id": 2}],
            },
            status_code=200,
    ...
    def test_find_draft_services_by_framework_iter(self, data_client, rmock):
        rmock.get(
            ...
            json={
                "links": {
                    "next": "http://baseurl/draft-services/framework/g-cloud-12?status=submitted&page=2"
                },
        ...
        rmock.get(
            ...
            json={
                "links": {
                    "prev": "http://baseurl/draft-services/framework/g-cloud-12?status=submitted"
                },
                "services": [{"foo": "baz"}],
            },
            status_code=200,
        ...
        result = data_client.find_draft_services_by_framework_iter(
            "g-cloud-12", status="submitted"
        )
    ...
    @pytest.mark.parametrize(
        ...
        (
            ...
            (
                "direct-award/projects/1/searches?user-id=123",
                {"project_id": 1, "user_id": 123},
            ),
        ),
    )
    def test_find_direct_award_project_searches_iter(
        self, data_client, rmock, url_path, iter_kwargs
    ):
        self._test_find_iter(
            data_client,
            rmock,
    ...
    def test_get_direct_award_project_services(self, data_client, rmock):
        rmock.get(
            "/direct-award/projects/1/services",
            json={"services": "ok"},
            status_code=200,
        )
    ...
    def test_get_direct_award_project_services_specific_fields(
        self, data_client, rmock
    ):
        rmock.get(
            "/direct-award/projects/1/services?user-id=123&fields=id,price",
            json={"services": "ok"},
            status_code=200,
        )

        result = data_client.find_direct_award_project_services(
            user_id=123, project_id=1, fields=["id", "price"]
        )
        assert result == {"services": "ok"}
    ...
    def test_find_communications_iter_additional_arguments(self, data_client, rmock):
        ...
        result = data_client.find_communications_iter(
            framework="g-cloud-6", supplier_id=123
        )
        results = list(result)
    ...
    def test_find_lot_questions_responses_by_framework_lot_route_iter(
        self, data_client, rmock
    ):
        self._test_find_iter(
            data_client,
    ...
    def test_find_lot_questions_responses_applicants_for_framework_route_iter(
        self, data_client, rmock
    ):
        self._test_find_iter(
            data_client,
            rmock,
            method_name="find_lot_questions_responses_applicants_for_framework_route_iter",
            model_name="lotQuestionsResponses",
            url_path="lot-questions-responses/applications?framework=g-cloud-6&route=g-lot",
            iter_kwargs={"framework_slug": "g-cloud-6", "route": "g-lot"},
        )
    ...
    def test_find_evaluator_framework_lots_iter(self, data_client, rmock):
        self._test_find_iter(
            ...
            url_path="evaluations/evaluator-framework-lots?framework=g-cloud-6&route=g-things&assigned=True",
            iter_kwargs={"framework": "g-cloud-6", "route": "g-things"},
        )

    def test_find_evaluator_framework_lots_iter_additional_arguments(
        self, data_client, rmock
    ):
        rmock.get(
            "http://baseurl/evaluations/evaluator-framework-lots?"
            "framework=g-cloud-6&route=g-things&assigned=True&user_id=123",
            json={"links": {}, "evaluatorFrameworkLots": [{"id": 1}, {"id": 2}]},
            status_code=200,
        )

        result = data_client.find_evaluator_framework_lots_iter(
            "g-cloud-6", "g-things", user_id=123
        )
        results = list(result)
    ...
    def test_find_evaluator_framework_lot_sections_iter(self, data_client, rmock):
        self._test_find_iter(
            ...
            url_path="evaluations/evaluator-framework-lot-sections?framework=g-cloud-6&route=g-things&assigned=True",
            iter_kwargs={"framework": "g-cloud-6", "route": "g-things"},
        )

    def test_find_evaluator_framework_lot_sections_iter_additional_arguments(
        self, data_client, rmock
    ):
        rmock.get(
            "http://baseurl/evaluations/evaluator-framework-lot-sections?"
            "framework=g-cloud-6&route=g-things&assigned=True&section_slug=the-slug",
    ...
    def test_find_evaluator_framework_lot_section_evaluations_iter(
        self, data_client, rmock
    ):
        self._test_find_iter(
            data_client,
            ...
            url_path="evaluations/evaluator-framework-lot-section-evaluations?framework=g-cloud-6&route=g-things",
            iter_kwargs={"framework": "g-cloud-6", "route": "g-things"},
        )

    def test_find_evaluator_framework_lot_section_evaluations_iter_additional_arguments(
        self, data_client, rmock
    ):
        rmock.get(
            "http://baseurl/evaluations/evaluator-framework-lot-section-evaluations?"
            "framework=g-cloud-6&route=g-things&section_slug=the-slug",
            json={
                "links": {},
    ...
    def test_find_supplier_framework_applications_by_route_iter(
        self, data_client, rmock
    ):
        self._test_find_iter(
            data_client,
            rmock,
            method_name="find_supplier_framework_applications_by_route_iter",
            model_name="supplierFrameworks",
            url_path="frameworks/g-cloud-6/suppliers/applications?route=g-things",
            iter_kwargs={
    ...
    def test_find_lot_questions_response_section_evaluations_iter(
        self, data_client, rmock
    ):
        self._test_find_iter(
            data_client,
            ...
            url_path="lot-questions-response-section-evaluations?framework=g-cloud-6&route=g-things",
            iter_kwargs={"framework": "g-cloud-6", "route": "g-things"},
        )

    def test_find_lot_questions_response_section_evaluations_iter_additional_arguments(
        self, data_client, rmock
    ):
        rmock.get(
            "http://baseurl/lot-questions-response-section-evaluations?framework=g-cloud-6&route=g-things"
...
class TestCommunicationsMethods(object):
    ...
    def test_find_communications_adds_framework_parameter(self, data_client, rmock):
        rmock.get(
    ...
    def test_find_communications_adds_resolved_parameter(self, data_client, rmock):
        rmock.get(
    ...
    def test_find_communications_adds_resolution_parameter(self, data_client, rmock):
        rmock.get(
    ...
    def test_find_communications_adds_category_parameter(self, data_client, rmock):
        rmock.get(
    ...
    def test_resolve_communication(self, data_client, rmock):
        ...
        result = data_client.resolve_communication(
            123, 456, "archived", "test@example.com"
        )
    ...
    def test_undo_resolve_communication(self, data_client, rmock):
        ...
        result = data_client.undo_resolve_communication(123, "test@example.com")
...
class TestSystemMessagesMethods(object):
    ...
    def test_update_system_with_show(self, data_client, rmock, show):
        ...
        result = data_client.update_system_message(
            "test-system-message", show=show, user="test@example.com"
        )
...
class TestLotQuestionsResponsesMethods(object):
    ...
    def test_find_lot_questions_responses_by_framework_lot_route(
        self, data_client, rmock
    ):
        rmock.get(
        ...
        result = data_client.find_lot_questions_responses_by_framework_lot_route(
            "g-cloud-6", "the-route"
        )
    ...
    def test_find_lot_questions_responses_by_framework_lot_route_adds_page_parameter(
        self, data_client, rmock
    ):
        rmock.get(
        ...
        result = data_client.find_lot_questions_responses_by_framework_lot_route(
            "g-cloud-6", "the-route", page=2
        )

        assert result == {"lotQuestionsResponses": "result"}
        assert rmock.called

    def test_find_lot_questions_responses_applicants_for_framework_route(
        self, data_client, rmock
    ):
        rmock.get(
            "http://baseurl/lot-questions-responses/applications?framework=g-cloud-6&route=g-lot",
            json={"lotQuestionsResponses": "result"},
            status_code=200,
        )

        result = (
            data_client.find_lot_questions_responses_applicants_for_framework_route(
                "g-cloud-6", "g-lot"
            )
        )
    ...
    def test_find_lot_questions_responses_applicants_for_framework_route_adds_with_evaluations_parameter(
        self, data_client, rmock
    ):
        rmock.get(
            "http://baseurl/lot-questions-responses/applications?framework=g-cloud-6&route=g-lot&with_evaluations=True",
            json={"lotQuestionsResponses": "result"},
            status_code=200,
        )
    ...
    def test_find_lot_questions_responses_applicants_for_framework_route_adds_page_parameter(
        self, data_client, rmock
    ):
        rmock.get(
            "http://baseurl/lot-questions-responses/applications?framework=g-cloud-6&route=g-lot&page=2",
            json={"lotQuestionsResponses": "result"},
            status_code=200,
        )
    ...
    def test_create_lot_questions_response(self, data_client, rmock):
        ...
        result = data_client.create_lot_questions_response(
            1234, "g-cloud-6", "g-lot", "user"
        )
    ...
    def test_get_lot_questions_response_by_framework_route_suppler(
        self, data_client, rmock
    ):
        rmock.get(
            "http://baseurl/lot-questions-responses/frameworks/g-cloud-6/routes/g-things/suppliers/1234",
            json={"lotQuestionsResponses": "result"},
            status_code=200,
        )

        result = data_client.get_lot_questions_response_by_framework_route_suppler(
            "g-cloud-6", "g-things", 1234
        )

        assert result == {"lotQuestionsResponses": "result"}
        assert rmock.called

    def test_get_lot_questions_response_by_framework_route_suppler_should_return_404(
        self, data_client, rmock
    ):
        rmock.get(
            "http://baseurl/lot-questions-responses/frameworks/g-cloud-6/routes/g-things/suppliers/1234",
        ...
        try:
            data_client.get_lot_questions_response_by_framework_route_suppler(
                "g-cloud-6", "g-things", 1234
            )
        except HTTPError:
            assert rmock.called
    ...
    def test_update_lot_questions_response_with_page_questions(
        self, data_client, rmock
    ):
        rmock.patch(
            "http://baseurl/lot-questions-responses/1234",
        ...
        result = data_client.update_lot_questions_response(
            1234, {"question": "answer"}, "user", ["question"]
        )
    ...
    def test_validate_lot_questions_response_with_page_questions(
        self, data_client, rmock
    ):
        rmock.post(
            "http://baseurl/lot-questions-responses/1234/validate",
    ...
    def test_find_lot_questions_response_section_evaluations(self, data_client, rmock):
        rmock.get(
            ...
            "framework=g-cloud-6&route=g-things",
    ...
    def test_find_lot_questions_response_section_evaluations_adds_page_parameter(
        self, data_client, rmock
    ):
        rmock.get(
            "http://baseurl/lot-questions-response-section-evaluations?"
            "framework=g-cloud-6&route=g-things&page=2",
            json={"lotQuestionsResponseSectionEvaluations": "result"},
            status_code=200,
        )

        result = data_client.find_lot_questions_response_section_evaluations(
            "g-cloud-6", "g-things", page=2
        )

        assert result == {"lotQuestionsResponseSectionEvaluations": "result"}
        assert rmock.called

    def test_find_lot_questions_response_section_evaluations_adds_section_slug_parameter(
        self, data_client, rmock
    ):
        rmock.get(
            "http://baseurl/lot-questions-response-section-evaluations?"
    ...
    def test_create_lot_questions_response_section_evaluation(self, data_client, rmock):
        ...
        result = data_client.create_lot_questions_response_section_evaluation(
            1234,
            "the-slug",
            {"comment": "This is the comment", "score": "50"},
            ["comment", "score"],
            "user",
        )
...
class TestEvaluatorFrameworkLotMethods(object):
    ...
    def test_find_evaluator_framework_lots_adds_framework_parameter(
        self, data_client, rmock
    ):
        rmock.get(
    ...
    def test_find_evaluator_framework_lots_adds_lot_parameter(self, data_client, rmock):
        rmock.get(
            "http://baseurl/evaluations/evaluator-framework-lots?framework=g-cloud-6&route=g-things&assigned=True",
            json={"evaluatorFrameworkLots": "result"},
            status_code=200,
        )
    ...
    def test_find_evaluator_framework_lots_adds_page_parameter(
        self, data_client, rmock
    ):
        rmock.get(
            "http://baseurl/evaluations/evaluator-framework-lots?framework=g-cloud-6&route=g-things"
            "&assigned=True&page=2",
            json={"evaluatorFrameworkLots": "result"},
            status_code=200,
        )
    ...
    def test_find_evaluator_framework_lots_adds_user_id_parameter(
        self, data_client, rmock
    ):
        rmock.get(
            "http://baseurl/evaluations/evaluator-framework-lots?"
            "framework=g-cloud-6&route=g-things&assigned=True&user_id=1",
            json={"evaluatorFrameworkLots": "result"},
            status_code=200,
        )

        result = data_client.find_evaluator_framework_lots(
            "g-cloud-6", "g-things", user_id=1
        )

        assert result == {"evaluatorFrameworkLots": "result"}
        assert rmock.called

    def test_find_evaluator_framework_lots_adds_assigned_parameter(
        self, data_client, rmock
    ):
        rmock.get(
            "http://baseurl/evaluations/evaluator-framework-lots?framework=g-cloud-6&route=g-things&assigned=False",
            json={"evaluatorFrameworkLots": "result"},
            status_code=200,
        )

        result = data_client.find_evaluator_framework_lots(
            "g-cloud-6", "g-things", assigned=False
        )

        assert result == {"evaluatorFrameworkLots": "result"}
        assert rmock.called

    def test_find_evaluator_framework_lot_adds_with_sections_parameter(
        self, data_client, rmock
    ):
        rmock.get(
            "http://baseurl/evaluations/evaluator-framework-lots?"
            "framework=g-cloud-6&route=g-things&assigned=True&with_sections=True",
            json={"evaluatorFrameworkLotSections": "result"},
            status_code=200,
        )

        result = data_client.find_evaluator_framework_lots(
            "g-cloud-6", "g-things", with_sections=True
        )

        assert result == {"evaluatorFrameworkLotSections": "result"}
        assert rmock.called

    def test_find_evaluator_framework_lot_adds_with_evaluations_parameter(
        self, data_client, rmock
    ):
        rmock.get(
            "http://baseurl/evaluations/evaluator-framework-lots?"
            "framework=g-cloud-6&route=g-things&assigned=True&with_evaluations=True",
            json={"evaluatorFrameworkLotSections": "result"},
            status_code=200,
        )

        result = data_client.find_evaluator_framework_lots(
            "g-cloud-6", "g-things", with_evaluations=True
        )
    ...
    def test_get_evaluator_framework_lot_adds_with_sections_parameter(
        self, data_client, rmock
    ):
        rmock.get(
    ...
    def test_get_evaluator_framework_lot_adds_with_evaluations_parameter(
        self, data_client, rmock
    ):
        rmock.get(
    ...
    def test_find_evaluator_framework_lot_sections(self, data_client, rmock):
        rmock.get(
            "http://baseurl/evaluations/evaluator-framework-lot-sections?"
            "framework=g-cloud-6&route=g-things&assigned=True",
            json={"evaluatorFrameworkLotSections": "result"},
            status_code=200,
        )

        result = data_client.find_evaluator_framework_lot_sections(
            "g-cloud-6", "g-things"
        )
    ...
    def test_find_evaluator_framework_lot_sections_adds_page_parameter(
        self, data_client, rmock
    ):
        rmock.get(
            "http://baseurl/evaluations/evaluator-framework-lot-sections?"
            "framework=g-cloud-6&route=g-things&assigned=True&page=2",
            json={"evaluatorFrameworkLotSections": "result"},
            status_code=200,
        )
    ...
    def test_find_evaluator_framework_lot_sections_adds_section_slug_parameter(
        self, data_client, rmock
    ):
        rmock.get(
            "http://baseurl/evaluations/evaluator-framework-lot-sections?"
    ...
    def test_find_evaluator_framework_lot_sections_adds_assigned_parameter(
        self, data_client, rmock
    ):
        rmock.get(
            "http://baseurl/evaluations/evaluator-framework-lot-sections?"
            "framework=g-cloud-6&route=g-things&assigned=False",
            json={"evaluatorFrameworkLotSections": "result"},
            status_code=200,
        )
    ...
    def test_find_evaluator_framework_lot_sections_adds_locked_parameter(
        self, data_client, rmock
    ):
        rmock.get(
            "http://baseurl/evaluations/evaluator-framework-lot-sections?"
        ...
        result = data_client.find_evaluator_framework_lot_sections(
            "g-cloud-6", "g-things", locked=True
        )

        assert result == {"evaluatorFrameworkLotSections": "result"}
        assert rmock.called

    def test_find_evaluator_framework_lot_sections_adds_with_evaluations_parameter(
        self, data_client, rmock
    ):
        rmock.get(
            "http://baseurl/evaluations/evaluator-framework-lot-sections?"
    ...
    def test_update_assigned_sections_for_evaluator_framework_lot(
        self, data_client, rmock
    ):
        rmock.post(
            "http://baseurl/evaluations/evaluator-framework-lot-sections",
    ...
    def test_get_evaluator_framework_lot_section_adds_with_evaluations_parameter(
        self, data_client, rmock
    ):
        rmock.get(
        ...
        result = data_client.get_evaluator_framework_lot_section(
            1234, with_evaluations=False
        )
    ...
    def test_find_evaluator_framework_lot_section_evaluations_adds_page_parameter(
        self, data_client, rmock
    ):
        rmock.get(
            "http://baseurl/evaluations/evaluator-framework-lot-section-evaluations?"
    ...
    def test_find_evaluator_framework_lot_section_evaluations_adds_section_slug_parameter(
        self, data_client, rmock
    ):
        rmock.get(
            "http://baseurl/evaluations/evaluator-framework-lot-section-evaluations?"
    ...
    def test_find_evaluator_framework_lot_section_evaluations_adds_evaluator_framework_lot_id_parameter(
        ...
        rmock.get(
            "http://baseurl/evaluations/evaluator-framework-lot-section-evaluations?"
            "framework=g-cloud-6&route=g-things&evaluator_framework_lot_id=1234",
            json={"evaluatorFrameworkLotSectionEvaluations": "result"},
            status_code=200,
        )
    ...
    def test_find_evaluator_framework_lot_section_evaluations_adds_supplier_id_parameter(
        self, data_client, rmock
    ):
        rmock.get(
            "http://baseurl/evaluations/evaluator-framework-lot-section-evaluations?"
            "framework=g-cloud-6&route=g-things&supplier_id=123",
            json={"evaluatorFrameworkLotSectionEvaluations": "result"},
            status_code=200,
        )

        result = data_client.find_evaluator_framework_lot_section_evaluations(
            "g-cloud-6", "g-things", supplier_id=123
        )

        assert result == {"evaluatorFrameworkLotSectionEvaluations": "result"}
        assert rmock.called

    def test_create_evaluator_framework_lot_section_evaluation(
        self, data_client, rmock
    ):
        rmock.post(
            "http://baseurl/evaluations/evaluator-framework-lot-section-evaluations",
    ...
    def test_get_evaluator_framework_lot_section_evaluation_with_lot_questions_response(
        self, data_client, rmock
    ):
        rmock.get(
            "http://baseurl/evaluations/evaluator-framework-lot-section-evaluations/1234"
        ...
        result = data_client.get_evaluator_framework_lot_section_evaluation(
            1234, with_lot_questions_response=True
        )

        assert result == {"evaluatorFrameworkLotSectionEvaluations": "result"}
        assert rmock.called

    def test_update_evaluator_framework_lot_section_evaluation(
        self, data_client, rmock
    ):
        rmock.post(
            "http://baseurl/evaluations/evaluator-framework-lot-section-evaluations/1234",
...
class TestTechnicalAbilityCertificatesMethods(object):
    ...
    def test_find_technical_ability_certificates_adds_page_parameter(
        self, data_client, rmock
    ):
        rmock.get(
        ...
        result = data_client.find_technical_ability_certificates(
            1234, "g-cloud-6", page=2
        )
    ...
    def test_create_technical_ability_certificates(self, data_client, rmock):
        ...
        result = data_client.create_technical_ability_certificate(
            1234, "g-cloud-6", "g-lot", "user"
        )
    ...
    def test_authenticate_technical_ability_certificate(self, data_client, rmock):
        ...
        result = data_client.authenticate_technical_ability_certificate(
            "1234", "123456", "user"
        )
    ...
    def test_update_technical_ability_certificate_with_page_questions(
        self, data_client, rmock
    ):
        rmock.patch(
            "http://baseurl/technical-ability-certificates/1234",
    ...
    def test_revert_technical_ability_certificate_to_in_progress(
        self, data_client, rmock
    ):
        rmock.post(
        ...
        result = data_client.revert_technical_ability_certificate_to_in_progress(
            1234, "user"
        )
...
class TestLotPricingsMethods(object):
    ...
    def test_find_lot_pricings_by_framework_lot_route(self, data_client, rmock):
        ...
        result = data_client.find_lot_pricings_by_framework_lot_route(
            "g-cloud-6", "the-route"
        )
    ...
    def test_find_lot_pricings_by_framework_lot_route_adds_page_parameter(
        self, data_client, rmock
    ):
        rmock.get(
    ...
    def test_get_lot_pricing_should_return_404(self, data_client, rmock):
        rmock.get("http://baseurl/lot-pricings/1234", status_code=404)
